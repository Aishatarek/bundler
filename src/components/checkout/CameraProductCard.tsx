...
export function CameraProductCard({
  ...
  return (
    <article
      ...
      className={`relative box-border flex min-w-0 flex-none flex-row items-center rounded-[10px] border-2 bg-white p-[11px] max-[1196px]:!h-[331.1px] max-[1196px]:!w-auto max-[1196px]:flex-1 max-[1196px]:flex-col max-[1196px]:items-center max-[1196px]:justify-center max-[1196px]:px-[11px] max-[1196px]:py-[14px] ${desktopGap} ${desktopBorder} ${tabletBorder} ${cardWidth != null ? 'min-[1197px]:mx-auto' : ''}`}
    >
