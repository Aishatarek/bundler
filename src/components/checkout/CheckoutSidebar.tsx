...
export function CheckoutSidebar({
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-2 min-[1197px]:w-[350px] min-[1197px]:shrink-0 min-[777px]:max-[1196px]:flex-1 max-[776px]:gap-1">
      {/* Desktop sidebar & mobile — compact badge + pricing row */}
      <div className="hidden min-[1197px]:flex min-[1197px]:items-center min-[1197px]:justify-between min-[1197px]:gap-2 max-[776px]:flex max-[776px]:items-center max-[776px]:justify-between max-[776px]:gap-2">
        <img
          src={offerBadge}
      ...
      <div className="hidden min-[777px]:max-[1196px]:flex min-[777px]:max-[1196px]:flex-col min-[777px]:max-[1196px]:gap-4">
        <div className="flex items-center gap-[25px] min-[777px]:max-[900px]:gap-4">
          <img
            src={offerBadge}
            alt="100% Wyze satisfaction guarantee"
      ...
      <div className="flex flex-col gap-1 pt-2.5 max-[1196px]:pt-2.5 min-[1197px]:pt-[10px] max-[776px]:pt-2.5">
        ...
        <Button
          variant="text"
          className="w-full text-center max-[776px]:text-xs max-[776px]:leading-[14.4px]"
          onClick={onSave}
          disabled={isSaved}
        >
